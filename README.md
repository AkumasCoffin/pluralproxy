...
#    Then open https://yourdomain.example.com
```
...
|---|---|
| `SITE_URL` | Your public URL (e.g. `https://yourdomain.example.com`) |
| `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY` | Clerk publishable key (`pk_live_...`) |
| `CLERK_SECRET_KEY` | Clerk secret key (`sk_live_...`) |
| `CLERK_FRONTEND_API` | Clerk proxy domain (e.g. `https://clerk.yourdomain.com`) — falls back to jsDelivr CDN |
